...
class ReviewTest extends BrewCrewTest {
	...
	public final function setUp() {
		...
		$this->user = new User(null, $this->brewery->getBreweryId(), 0, 1, '1980-01-01', "anon@test.com", "John", $hash, "Smith", $salt, "beerfan4lyfe");
	...
	public function testInsertValidReview() {
		...
		$this->assertEquals($pdoReview->getReviewBeerId(), $this->beer->getBeerId());
		$this->assertEquals($pdoReview->getReviewUserId(), $this->user->getUserId());
